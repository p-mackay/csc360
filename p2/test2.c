...
void printTime() {
    ...
    long elapsedSeconds = currentTime.tv_sec - startTime.tv_sec;
    long elapsedNanoseconds = currentTime.tv_nsec - startTime.tv_nsec;

    if (elapsedNanoseconds < 0) {
        elapsedSeconds--;
        elapsedNanoseconds += 1000000000L;
    }

    printf("%02ld:%02ld:%02ld ", (elapsedSeconds / 3600) % 24, (elapsedSeconds / 60) % 60, elapsedSeconds % 60);
}
